...
#> Some legend labels were too wide. These labels have been resized to 0.60, 0.61. Increase legend.width (argument of tm_layout) to make the legend wider and therefore the labels larger.
```
